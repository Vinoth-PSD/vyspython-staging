...
class LoginView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            profile_image = 'https://matrimonyapi.rainyseasun.com'+profile_icon
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            def get_filtered_images(profile_ids):
                base_url = "https://matrimonyapi.rainyseasun.com/media/"
...
def matching_gallery(profile_id):
        ...
        base_url = 'https://matrimonyapi.rainyseasun.com/'
      ...
      if serializer.is_valid():   
        ...
        #   profile_details[0]['birth_rasi_name']  
          ...
          if(Profile_horoscope_file):
                ...
                Profile_horoscope_file_link='https://matrimonyapi.rainyseasun.com/media/'+Profile_horoscope_file 
...
class ListProfileImagesView(APIView):
 ...
 def post(self, request, *args, **kwargs):
        ...
        url_prefix = "https://matrimonyapi.rainyseasun.com/images/"
...
class CreateOrRetrieveRoom(APIView):
    def post(self, request):
        ...
        if room:
            ...
            return JsonResponse({'room_id': room.id, 'created': False}, status=status.HTTP_200_OK)
        else:
            # Room doesn't exist, create a new one
            new_room = models.Room.objects.create(id=room_id, name=room_id)
            return JsonResponse({'room_id': new_room.id, 'created': True}, status=status.HTTP_201_CREATED)
...
class GetUserRooms(APIView):
    def post(self, request):
        ...
        rooms = models.Room.objects.filter(id__contains=user_id).values_list('id', flat=True)
        return JsonResponse({'rooms': list(rooms)}, status=status.HTTP_200_OK)
...
def send(request):
    ...
    new_message = models.message.objects.create(value=message, user=username, room=room)
    new_message.save()
